...
l'équation~\eqref{eq:core_five_coefficients} fournit le contrôle final :
\begingroup\small
\begin{equation}
\begin{array}{c|rrrrr}
...
est le premier test unitaire de la chaîne de calcul.
...
\begin{enumerate}[label=\textbf{R\arabic*.},leftmargin=3.2em,itemsep=2pt]
  ...
  équations~\eqref{eq:core_zvr_final_kernel},
  ...
  l'équation~\eqref{eq:core_scalar_residual}.
\end{enumerate}
