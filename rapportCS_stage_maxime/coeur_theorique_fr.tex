...
fixée à $A_{0,1}^{(u)}=2\kappa$, afin de reprendre celle du potentiel
$E_{001}(u)$ de Mayer. La reconstruction du noyau à partir des autres
paramètres publiés donne une valeur légèrement différente dans la convention
d'Ewald utilisée ; son origine reste à préciser. Nous conservons donc la
dispersion ainsi reconstruite et ajustons sa valeur en $\Gamma$ à
$2\kappa$, avant de calculer les corrections SCHA. À $500\,\mathrm K$,
sous pression nulle et sur une grille $40^3$, retenir plutôt la valeur
reconstruite augmente la susceptibilité d'environ $1.7\,\%$. Cette sensibilité,
évaluée à une seule température, accompagne la comparaison avec la dynamique
moléculaire : les deux approches reprennent le même potentiel anharmonique
réduit, mais diffèrent par ce choix harmonique et par le traitement classique
ou quantique des fluctuations.\footnote{La masse acoustique utilisée pour les
courbes est $46.44\,\mathrm{amu}$, au lieu des $46.64\,\mathrm{amu}$ de
Nishimatsu~\cite{Nishimatsu2016}. Dans les mêmes conditions de calcul à
$500\,\mathrm K$, cette différence modifie la susceptibilité de moins de
$0.0003\,\%$ pour les deux jeux de paramètres BaTiO$_3$ considérés.}
