...
anharmonique, avec un choix explicite d'ancrage harmonique illustré par la
figure~\ref{fig:core_mayer_reduction}. Il faut donc distinguer « même modèle réduit » de
