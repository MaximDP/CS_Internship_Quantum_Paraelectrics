...
\begingroup
\fontsize{10.2pt}{11.9pt}\selectfont
...
\endhead
C1 --- Complexité &
Décomposition traçable du problème, en séparant les degrés de liberté et en
utilisant les outils de la matière condensée et de la théorie des champs : DFT
$\rightarrow$ Hamiltonien effectif
...
intégration structurée de l'IA dans le flux de travail, au moyen de compétences
spécialisées (\emph{skills}), de modules complémentaires (\emph{plugins}) et de
plusieurs agents coordonnés, plutôt que par de simples requêtes ponctuelles.
& \\
\hline
C7 --- Convaincre &
