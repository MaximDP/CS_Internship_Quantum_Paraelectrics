...
La livraison finale est disponible dans le dépôt GitHub
\href{https://github.com/MaximDP/CS_Internship_Quantum_paraelctrics}
{du stage au SPMS}. Ce dépôt
constitue le point d'entrée du travail : il réunit le rapport, la soutenance Beamer,
la chaîne SCHA effectivement exécutée, les jeux de paramètres et de données
sources nécessaires, les figures livrées et les instructions de reproduction.
Chaque version exploitable pourra ainsi être identifiée par un
commit Git et, le cas échéant, par une version taguée.
...
\begin{itemize}
  ...
  \item dans la pipeline, \texttt{inputs/} regroupe les configurations et données,
