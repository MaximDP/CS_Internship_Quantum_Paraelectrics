...
la \hyperref[sec:core_scha_variational_principle]{\textcolor{blue}{section~\ref*{sec:core_scha_variational_principle}}}.
...
membre de droite de l'équation~\eqref{eq:core_ferro_full_closure}, évalué à $K=0$,
...
l'équation~\eqref{eq:core_ferro_full_closure} redonne
l'équation~\eqref{eq:core_full_scha_tensor}.
...
l'équation~\eqref{eq:core_ferro_general_wick_rule}; le système est donc défini sans
